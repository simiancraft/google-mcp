...
describe('trash_file', () => {
  it('sets exactly the trashed flag and projects the trashed file', async () => {
    const captured: Captured = {};
    const result = await handler(fakeDrive(captured, { id: 'F1', trashed: true }), {
      fileId: 'F1',
    });
    ...
    expect(result).toEqual({ id: 'F1', trashed: true });
