...
type Captured = { params?: drive_v3.Params$Resource$Drives$Get };

function fakeDrive(captured: Captured, data: drive_v3.Schema$Drive): drive_v3.Drive {
  return {
    drives: {
      get: async (params: drive_v3.Params$Resource$Drives$Get) => {
...
describe('get_shared_drive', () => {
  it('gets and projects the shared drive', async () => {
