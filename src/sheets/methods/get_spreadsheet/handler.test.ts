        ...
        sheets: [
          {
            ...
            bandedRanges: [{ bandedRangeReference: 'table/4/banding/1', range: { sheetId: 0 } }],
            rowGroups: [{ range: { sheetId: 0, dimension: 'ROWS' }, depth: 1 }],
            columnGroups: [{ range: { sheetId: 0, dimension: 'COLUMNS' }, depth: 1 }],
          },
        ],
      }),
      { spreadsheetId: 'S1' },
