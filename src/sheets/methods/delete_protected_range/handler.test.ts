...
describe('delete_protected_range', () => {
  it('deletes the protected range by id', async () => {
    ...
    expect(captured.params).toEqual({
      spreadsheetId: 'SS',
      requestBody: {
        requests: [{ deleteProtectedRange: { protectedRangeId: 41 } }],
      },
    });
    expect(result).toEqual({ spreadsheetId: 'SS', protectedRangeId: 41 });
