...
<p align="center">
  <sub><strong>Gmail</strong> (<a href="./src/gmail/CAPABILITIES.md">33 operations</a>), <strong>Calendar</strong> (<a href="./src/calendar/CAPABILITIES.md">25 operations</a>), <strong>Sheets</strong> (<a href="./src/sheets/CAPABILITIES.md">15 operations</a>), and <strong>Docs</strong> (<a href="./src/docs/CAPABILITIES.md">9 operations</a>) ship today; Drive is on the way (shown dimmed).</sub>
</p>
