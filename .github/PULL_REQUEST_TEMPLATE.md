...
Conventional Commits: type(scope): subject. Scope is the area (auth, lib, doctor, gmail, calendar, sheets, docs, drive, ...).
-->
...
- [ ] README / service README / AGENTS.md updated if a public surface or convention changed
